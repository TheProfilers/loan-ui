...
export default function LoanDetailsLayout() {
  ...
  return (
    ...
    <div className='actual-receipt'>
      ...
      <h1 className="text-sm font-medium text-orange-500 uppercase">
        Borrower Information
      </h1>
     {loan.loanee? <div className="overflow-x-auto">
        ...
        <tbody>
          <tr>
            <td>{loan.loanee.firstName} {loan.loanee.firstName}</td>
      ...
      <div className="overflow-x-auto">
        ...
        <tbody>
          <tr>
            ...
            {loan.receivedBy ? <td>{formatDate(loan.updatedAt!)}</td> : <td>Not Paid</td>}
            <td>{formatCurrency(loan.loanAmount - loan.amountPaid).toString()}</td>
          </tr>
        </tbody>
        </table>
      </div>
      ...
      <h1 className="text-sm font-medium text-orange-500 uppercase py-1">
        Served By
      </h1>

      {loan.servedBy ? <div className="overflow-x-auto">
      <table className="table table-xs">
        <thead>
          <tr>
            <th>Name</th>
      ...
      {loan.receivedBy ? <div className="overflow-x-auto">
      <table className="table table-xs">
        <thead>
          <tr>
            <th>Name</th>
