...
import { useDeleteShopAgent } from '../shop_agents/useDeleteShopAgent';
            ...
            data?.map((agent,index) => (
                ...
                <td>
                  <div className="flex space-x-1">
                    <Link to={`/stock/${agent._id}`} className="btn btn-sm btn-square bg-green-500 hover:bg-green-400 text-white">
                      <BsFillEyeFill />
                    </Link>
